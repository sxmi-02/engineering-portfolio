...
source_id, a TEXT FOREIGN KEY referencing the report_source table. All columns in the incident_source table are required and hence should have the NOT NULL constraint applied.
Relationships
